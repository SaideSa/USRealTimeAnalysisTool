...
/**
 * This JUnit test is for testing the connection with the class LivestreamSource. As a prerequisite a device is needed to establish the connection,
...
class TestLiveStreamConnection {
	...
	/**
	 * This method tests if the connection to the device can be established. Here the parameter 0 in the constructor means that the first connected device to the computer is selected. (The device manager can help to identify the order of devices.)
