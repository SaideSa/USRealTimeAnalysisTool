...
import org.opencv.videoio.Videoio;
 ...
 /**
    * provides the  footage from a file with these formats:
    * mp4, avi, mkv, mov, 3GP, jpg and png
    * 
    * @author Team 3
    *
    */
public class FilestreamSource extends AbstractImageSource{
  ...
  /**
	 * constructs a new FilestreamSource object with the transmitted <code>path</code>.
	 * 
	 * @param path describes the path of the file 
	 */
  ...
  /**
	 * initializes a new VideoCapture object using the <code>path</code>. 
	 * The video or image is opened.
	 * 
